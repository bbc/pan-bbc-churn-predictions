...
--   demos.gender_enriched_missing_flag as profile_gender_enriched_missing_flag,
  ...
  case when iplayer_linreg.aw_2 is null then 0
       when iplayer_linreg.aw_2 = 1 and streaming_time_13w > 180 then 1
       else 0 end as iplayer_active_last_week,
  ...
  case when lw.series_premieres is null then 0 else lw.series_premieres end as lw_series_premieres,
...
-- 	devices.iplayer_ev_dev as device_iplayer_ev,
	devices.iplayer_st_desktop_web_perc as device_iplayer_st_desktop_web_perc,
	devices.iplayer_st_mobile_web_perc as device_iplayer_st_mobile_web_perc,
	devices.iplayer_st_app_perc as device_iplayer_st_app_perc,
	devices.iplayer_st_smart_tv_perc as device_iplayer_st_smart_tv_perc,
	devices.iplayer_st_other_web_perc as device_iplayer_st_other_web_perc,
	devices.iplayer_ev_desktop_web_perc as device_iplayer_ev_desktop_web_perc,
	devices.iplayer_ev_mobile_web_perc as device_iplayer_ev_mobile_web_perc,
	devices.iplayer_ev_app_perc as device_iplayer_ev_app_perc,
	devices.iplayer_ev_smart_tv_perc as device_iplayer_ev_smart_tv_perc,
	devices.iplayer_ev_other_web_perc as device_iplayer_ev_other_web_perc,
...
--   iplayer_acti.iplayer_activating_brand as iplayer_activating_masterbrand,
  ...
  timeandday.tod_breakfast as iplayer_tod_breakfast,
  timeandday.tod_daytime as iplayer_tod_daytime,
  timeandday.tod_earlypeak as iplayer_tod_earlypeak,
  timeandday.tod_peak as iplayer_tod_peak,
  timeandday.tod_late as iplayer_tod_late,
  timeandday.tod_overnight as iplayer_tod_overnight,
  timeandday.dow_monday as iplayer_dow_monday,
  timeandday.dow_tuesday as iplayer_dow_tuesday,
  timeandday.dow_wednesday as iplayer_dow_wednesday,
  timeandday.dow_thursday as iplayer_dow_thursday,
  timeandday.dow_friday as iplayer_dow_friday,
