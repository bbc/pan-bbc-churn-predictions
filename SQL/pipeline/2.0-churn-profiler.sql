DROP TABLE IF EXISTS central_insights_sandbox.ap_churn_iplayer_score_sample_profiler;
CREATE TABLE central_insights_sandbox.ap_churn_iplayer_score_sample_profiler AS
...
FROM central_insights_sandbox.ap_churn_iplayer_score_sample base
