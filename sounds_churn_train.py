...
def sqrt_candidate(element):
    return 'genre_st_' in element or \
           ...
           ('sounds_prod_ev_' in element and 'perc' not in element) or \
           'mkt_email_' in element

# suppressing for interpretability
...
## MODEL SPECIFICATION
## =======================
from configs.sounds import simple_learner
from configs.sounds import lgbm_learner
from configs.sounds import diverse_stack
